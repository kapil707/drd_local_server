...
<html lang="en">
  <head>
    ...
    <title>
		Dr. Distributor || Delivery Report
    </title>
    <meta charset utf="8">
	...
	<div class="row">
		...
		<div class="card-columns">
			<div class="card bg-success">
			  <div class="card-body text-center">
				<p class="card-text">Total Invoices (<?= $this->Drd_Invoice_Model->total_invoice("") ?>)</p>
			  </div>
			</div>
			<div class="card bg-warning">
			  <div class="card-body text-center">
				<p class="card-text">Total Pickedby (<?= $this->Drd_Invoice_Model->total_invoice("!pickedby") ?>) Pending (<?= $this->Drd_Invoice_Model->total_invoice("pickedby") ?>)</p>
			  </div>
			</div>
			<div class="card bg-danger">
			  <div class="card-body text-center">
				<p class="card-text">Total Deliverby (<?= $this->Drd_Invoice_Model->total_invoice("!deliverby") ?>) Pending (<?= $this->Drd_Invoice_Model->total_invoice("deliverby") ?>)</p>
			  </div>
			</div>
		  </div>
		</div>
		...
		<table id="example" class="display table table-striped table-bordered" aria-describedby>
			...
			<tbody>
				<?php
				$i = 1;
				$result = $this->Drd_Invoice_Model->today_invoice_to_show($_GET);
